...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  }).then(ui.onPostSuccess).catch(ui.onError);
	};
	...
	var onGetGames = function onGetGames(event) {
	  ...
	  if (data.game.id.length === 0) {
	    ...
	    api.show(data.game.id).then(ui.onGetSuccess).catch(ui.onError);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(ui.signUpSuccess).catch(ui.emailFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emailFailure = function emailFailure(error) {
	  console.error(error);
